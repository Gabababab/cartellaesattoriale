...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(ContribuenteConCartelleAssociateException.class)
	public ResponseEntity<Object> handleContribuenteConCartelleAssociateException(ContribuenteConCartelleAssociateException ex,
			WebRequest request) {
